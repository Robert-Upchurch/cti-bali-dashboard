...
const taskData = {
  ciee: [
    // URGENT — from Jessica Dubra emails Mar 25 + Feb 11, 2026
    { id: 100, task: 'URGENT: Confirm CTI team names & Bali arrival details to Jessica Dubra', category: 'Bali Apr 11', status: 'Not Started', assigned: 'Robert', priority: 'Urgent', startDate: '2026-03-25', dueDate: '2026-03-27', completedDate: '', notes: 'Jessica (Mar 25): "Could you confirm who from your team will be traveling and their arrival details in Bali? We are working on organizing a sponsor dinner and would love to coordinate accordingly."', attachments: [] },
    { id: 101, task: 'URGENT: Decide on virtual event with Northern Hospitality Group — reply to Jessica', category: 'Bali Apr 11', status: 'Not Started', assigned: 'Robert', priority: 'Urgent', startDate: '2026-03-25', dueDate: '2026-03-27', completedDate: '', notes: 'Jessica (Mar 25): "Regarding the virtual event with Northern, I will wait for your update once a decision has been made." Northern Hospitality Group — Downtown Anchorage, Alaska. Unlimited positions. Program start Aug 2026.', attachments: [] },
    { id: 102, task: 'URGENT: Notify all Culinary candidates — bring cutting board + vegetables to Apr 11 event', category: 'Bali Apr 11', status: 'Not Started', assigned: 'Stri Ratna', priority: 'Urgent', startDate: '2026-03-25', dueDate: '2026-03-30', completedDate: '', notes: 'Jessica (Mar 25): "Please ask your culinary participants to bring their cutting boards along with a few vegetables of their choice to complete the knife skills demonstration. NO meat, fish, or other proteins." Event is AFTER 2:00 PM on Apr 11.', attachments: [] },
    { id: 103, task: 'URGENT: Recruit candidates for Beemok Hospitality — South Carolina (Unlimited positions, Aug 2026)', category: 'New Employer', status: 'Not Started', assigned: 'Stri Ratna', priority: 'Urgent', startDate: '2026-03-25', dueDate: '2026-04-11', completedDate: '', notes: 'Beemok Hospitality — SC. Properties: Sorelle, The Charleston Place, The Cooper. Culinary $18.54/hr, F&B $3.86/hr + tips, Rooms $18.54/hr. Benefits: free uniform, meals, parking. Housing: 50 units (currently full), $750/mo. Start Aug 2026. UNLIMITED positions requested.', attachments: [] },
    { id: 104, task: 'URGENT: Recruit candidates for Northern Hospitality Group — Anchorage Alaska (Unlimited positions, Aug 2026)', category: 'New Employer', status: 'Not Started', assigned: 'Stri Ratna', priority: 'Urgent', startDate: '2026-03-25', dueDate: '2026-04-11', completedDate: '', notes: 'Northern Hospitality Group — Downtown Anchorage AK. Culinary $1,440 biweekly, F&B $13/hr + tips. Fully furnished housing $116/wk + $200 deposit. Glaciers, wildlife, hiking. Start Aug 2026. UNLIMITED positions requested. Virtual event pending decision.', attachments: [] },
